...
set-vars-from-dev:
	...
	@export API_DOMAIN_NAME=$(DEV_API_DOMAIN_NAME)
	@export API_DOMAIN_CERTIFICATE_NAME=$(DEV_API_DOMAIN_CERTIFICATE_NAME)
	@export ROUTE53_REGION=$(DEV_ROUTE53_REGION)
	@export ROUTE53_ZONE_ID=$(DEV_ROUTE53_ZONE_ID)
	@export ROUTE53_RECORD_TTL=$(DEV_ROUTE53_RECORD_TTL)
	@export ROUTE53_RECORD_TYPE=$(DEV_ROUTE53_RECORD_TYPE)
...
set-vars-from-prod:
	...
	@export API_DOMAIN_NAME=$(PROD_API_DOMAIN_NAME)
	@export API_DOMAIN_CERTIFICATE_NAME=$(PROD_API_DOMAIN_CERTIFICATE_NAME)
	@export ROUTE53_REGION=$(PROD_ROUTE53_REGION)
	@export ROUTE53_ZONE_ID=$(PROD_ROUTE53_ZONE_ID)
	@export ROUTE53_RECORD_TTL=$(PROD_ROUTE53_RECORD_TTL)
	@export ROUTE53_RECORD_TYPE=$(PROD_ROUTE53_RECORD_TYPE)
