...
from dynamicdns.aws.functions.info import (createAWSFunctions, AWSFunctions, info) 
...
# -----------------------------------------------------------------------------
    ...
    @patch('dynamicdns.aws.functions.info.createAWSFunctions') 
    ...
    def testInfoModuleFunctionFailRaw(self, mocked_create):
        ...
        result = info({ 'queryStringParameters': { 'raw': ''} },{})
